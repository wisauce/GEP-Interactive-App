...
export default function Password({show, setShow, section}) {
  ...
  return (
        <div className={`${section == 5 && "bg-[#F9EF6C]"} transition duration-1000 flex fixed justify-center items-center w-full h-[100vh] p-4 z-40 ${!show ? (section == 5 ? "opacity-0 pointer-events-none" : "-translate-y-[100vh]")  : ""}`}>
